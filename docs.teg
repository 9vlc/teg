# What's teg?
teg is a small (~600 LOC) portable web "[anti-framework](https://werc.cat-v.org)" foundation made in AWK,
...
# Why's teg?
I wanted a simple framework for my website to not write everything in HTML by hand.
Everything I looked at didn't fit me in one way or another, so I decided to just
make something of my own.


This project is to not be taken seriously. Heck, all of this is a giant shitpost.
I know this part is not even worth adding, but some people took this whole thing
as something serious like I'm going to pitch it to a company. Sorry, no I won't.
...
Here's an example of using inline calls to create a page that displays your distro name:
```
...
---
## Markdown
teg's markdown is relatively close to the one you are familiar with, except for some missing features like tables and 
